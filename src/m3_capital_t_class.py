    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        # ---------------------------------------------------------------------
        upper_h_rect = rg.Point(intersection_center.x - width / 2, intersection_center.y - letter_thickness / 2)
        lower_h_rect = rg.Point(intersection_center.x + width / 2, intersection_center.y + letter_thickness / 2)
        upper_v_rect = rg.Point(intersection_center.x - letter_thickness / 2, intersection_center.y - letter_thickness / 2)
        lower_v_rect = rg.Point(intersection_center.x + letter_thickness / 2, intersection_center.y + height - letter_thickness / 2)
        h_rect = rg.Rectangle(upper_h_rect, lower_h_rect)
        v_rect = rg.Rectangle(upper_v_rect, lower_v_rect)
